...
module.exports = {
    ...
    methods: {
        ...
        // ============================================================= //
        // External access
        onGeocodeAnAddress: function onGeocodeAnAddress(address) {
            var location = {
                address: address
            };
        ...
        onPanAndZoomToBounds: function onPanAndZoomToBounds(markerPayload) {
        ...
        makeAGeocodePromise: function makeAGeocodePromise(location) {
        ...
        retreiveGeocodeResults: function retreiveGeocodeResults(locationPromises, transmissionMethod) {
...
module.exports = {
    ...
    events: {
        ...
        geocodeThisAddress: function geocodeThisAddress(address) {
            this.$broadcast('geocodeAnAddress', address);
        },
        successfulGeocode: function successfulGeocode(resultPayload) {
            this.$broadcast('successfulGeocode', resultPayload);
        },
        failedGeocode: function failedGeocode(error) {
...
module.exports = {
    ...
    methods: {
        ...
        onSuccessfulGeocode: function onSuccessfulGeocode(result) {
...
},{"vue":59,"vue-hot-reload-api":58,"vueify-insert-css":60}],65:[function(require,module,exports){
var Vue = require('vue');
...
},{"./Mapper/mapper.vue":63,"vue":59}]},{},[65]);
